  ...
  <nav class="bg-white-800">
      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <img class="h-20 w-25" src="{{asset('images/file.png')}}" alt="Your Company">
          </div>
    ...
    <div class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <x-link href="/" :active="request()->is('/')" :isMobile="true">Home</x-link>
        <x-link href="/jobs" :active="request()->is('jobs')" :isMobile="true">Jobs</x-link>
        <x-link  href="/about" :active="request()->is('about')" :isMobile="true">About</x-link>
        <x-link href="/contact" :active="request()->is('contact')" :isMobile="true">Contact</x-link>
